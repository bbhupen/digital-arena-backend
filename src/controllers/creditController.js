...
const { getUnpaidCredits, getCreditDetailUsingBillId, updateCredit, getCreditHistory, getUnpaidCreditsByPhoneNumber, getUserUnpaidCredits } = require('../services/creditServices');
...
router.post("/api/v1/credit/get-users", async (req, res) => {
    const requestBody = req.body;
    const response = await getUserUnpaidCredits(requestBody);
